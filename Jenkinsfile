pipeline {
    ...
    post {
        success {
            sh (
                """
                    curl -s -X POST https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage -d chat_id="-1002426676593" -d text="Быковский Дмитрий собрал приложение."
                """
                )
        }
    }
